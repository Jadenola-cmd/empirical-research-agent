...
- 证据：
  - `golden_outputs/descriptive_all.json`：`run_descriptive() got an unexpected keyword argument 'columns'`
  - `golden_outputs/correlation_all.json`：`run_correlation() got an unexpected keyword argument 'columns'`
...
- 证据：`golden_outputs/core_summary_after_fix.json`
...
- 证据：`golden_outputs/negative_csv_to_data_audit.json`
- 影响：用户按文档传 CSV 会失败。
...
- 证据：`golden_outputs/data_audit_panel.json`
...
- 证据：`golden_outputs/negative_ols_invalid_json.err.txt`
...
- 证据：`golden_outputs/negative_summary.json`
...
- 证据：`golden_outputs/ols_corrected.json`、`golden_outputs/panel_corrected.json`
